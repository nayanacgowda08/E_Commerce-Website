...
const Navbar = ({handlePopUp}) => {
  return (
    <>
    <div className='shadow-md bg-white dark:bg-slate-800 duration-200 relative z-40 '>
            ...
            <div className="container flex justify-between items-center">
                ...
                <div className='flex justify-center items-center gap-4'>
                    <div className='relative group hidden sm:block'>
                        ...
                        rounded-lg border border-gray-300 py-1 px-2 text-sm focus:outline-none focus:border-1
                        focus:border-primary dark:border-gray-500 dark:bg-slate-800 '
                        /> 
                        <IoMdSearch className='text-slate-800 group-hover:text-primary
       ...
       <div data-aos="zoom-in" className='flex justify-center'>
            <ul className='sm:flex hidden items-center gap-4'>
                ...
                <li className='group relative cursor-pointer'>
                    ...
                    <span>
                        <FaCaretDown
                        className='transition-all duaration-200 group-hover:rotate-180'
                        />
                    </span>
                    </a>
                    <div
